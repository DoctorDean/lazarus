...
> ℹ️ The pinned image `lazarus/diffdock:site-ready` isn't published yet — `pull` fetches the contract (API + CLI + Dockerfile + smoke test) so it can be rebuilt.
...
> ℹ️ The pinned image `lazarus/fpocket:working` isn't published yet — `pull` fetches the contract (API + CLI + Dockerfile + smoke test) so it can be rebuilt.
...
> ℹ️ The pinned image `lazarus/masif:site-ready` isn't published yet — `pull` fetches the contract (API + CLI + Dockerfile + smoke test) so it can be rebuilt.
...
> ℹ️ The pinned image `lazarus/scannet:ppi-noMSA-proven` isn't published yet — `pull` fetches the contract (API + CLI + Dockerfile + smoke test) so it can be rebuilt.
